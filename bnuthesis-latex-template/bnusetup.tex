...
\bnusetup{
  ...
  %   可使用“\\”命令手动控制换行
  %
  title  = {FedViM：面向多中心海洋浮游生物监测的联邦分布外检测方法研究},
  title* = {FedViM: Federated Out-of-Distribution Detection for Multi-Center Marine Plankton Monitoring},
  %
  % 学科门类
  %   1. 学术型
  %      - 中文
  ...
  author  = {孙伟洲},
  author* = {Sun Weizhou},
  student-id = {202211079364},
  %
  % 导师
  %   中文姓名和职称之间以英文逗号“,”分开，下同
  %
  supervisor  = {谢传龙, 副教授},
  supervisor* = {Xie Chuanlong, Associate Professor},
  supervisor-department = {文理学院},
  %
  % 副导师
  %
...
\bnusetup{
  ...
  figurestables-chapternumber = true,  %false / true
}
